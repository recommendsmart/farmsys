...
class DataPolicy extends ControllerBase implements ContainerInjectionInterface {
   ...
   */
  public function revisionsOverviewPage($data_policy = NULL) {
    $build = [
    ...
    /** @var \Drupal\data_policy\Entity\DataPolicyInterface $data_policy_entity */
    $data_policy_entity = $data_policy_storage->load($data_policy);

    $account = $this->currentUser();
    $langcode = $data_policy_entity->language()->getId();
    $languages = $data_policy_entity->getTranslationLanguages();
    ...
    $vids = $data_policy_storage->revisionIds($data_policy_entity);
    ...
    foreach (array_reverse($vids) as $vid) {
      ...
      $links['view'] = [
        ...
        'url' => Url::fromRoute('entity.data_policy.revision', [
          'data_policy' => $data_policy_entity->id(),
          'data_policy_revision' => $vid,
          'entity_id' => $data_policy,
        ]),
      ];
